...
export async function getAllPosts ({ includePages = false }) {
  ...
  const response = await api.getPage(pageId, { gotOptions: defaultGotOptions })
  ...
  const collData = await api.getCollectionData(collectionId, viewId, {}, { gotOptions: defaultGotOptions })
